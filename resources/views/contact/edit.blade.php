                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <x-form.input type="text" id="first_name" name="first_name"
                                            placeholder="Enter your first name!" :value="old('first_name') ?? $contact->first_name"></x-form.input>
                                        @error('first_name')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-form.input type="text" id="middle_name" name="middle_name"
                                            placeholder="Enter your middle name!" :value="old('middle_name')?? $contact->middle_name"></x-form.input>
                                        @error('middle_name')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-form.input type="text" id="last_name" name="last_name"
                                            placeholder="Enter your last name!" :value="old('last_name')?? $contact->last_name"></x-form.input>
                                        @error('last_name')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-form.input type="email" id="email" name="email"
                                            placeholder="Enter your email!" :value="old('email')?? $contact->email"></x-form.input>
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-form.input type="text" id="phone_no" name="phone_no"
                                            placeholder="Enter your phone number!" :value="old('phone_no')?? $contact->phone_number"></x-form.input>
                                        @error('phone_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <x-form.input type="date" id="dob" name="dob"
                                            :value="old('dob') ?? $contact->dob "></x-form.input>
                                        @error('dob')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="address" id="address" class="form-control" cols="30" rows="2"
                                            placeholder="Enter your address!">{{ old('address') ?? $contact->address }}</textarea>
                                        @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
